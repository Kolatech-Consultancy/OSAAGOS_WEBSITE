...
const ApproveDenyGroupModal = ({ isOpen, onClose, onSave, action, loader }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 z-50 overflow-auto bg-gray-500 bg-opacity-75 flex">
      <div className="relative p-8 bg-white w-full max-w-md m-auto flex-col flex rounded-lg shadow-lg">
        <h2 className="text-xl font-semibold mb-4">{action} group</h2>
        <p>Are you sure you want to {action} this group? this action can't be undone!</p>
...
export default ApproveDenyGroupModal;
