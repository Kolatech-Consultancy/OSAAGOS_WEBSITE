...
const DeleteForumModal = ({ isOpen, onClose, onDelete,loader }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 z-50 overflow-auto bg-gray-500 bg-opacity-75 flex">
      <div className="relative p-8 bg-white w-full max-w-md m-auto flex-col flex rounded-lg shadow-lg">
        <h2 className="text-xl font-semibold mb-4">Delete forum</h2>
        <p>Are you sure you want to delete this forum? this action can't be undone!</p>
